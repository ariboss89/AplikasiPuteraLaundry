 ...
 * @author User
 */
public class FormLaporanPengeluaran extends javax.swing.JFrame {

    /**
     * Creates new form FormLaporanStok
     */
    public FormLaporanPengeluaran() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(cbBulan.getSelectedItem().equals("ALL")){
            ...
            try{
                ...
                String sql="select *from belanja where tanggal like '%"+cbTahun.getSelectedItem()+"%'";
            ...
            try{
                ...
                File file = new File("src/report/LaporanPengeluaran.jrxml");
                JasperDesign jasperDesign = JRXmlLoader.load(file);
                String sql="select *from belanja where tanggal like '%"+cbBulan.getSelectedItem()+"%' AND tanggal like '%"+cbTahun.getSelectedItem()+"%'";
                JRDesignQuery newQuery=new JRDesignQuery();
                newQuery.setText(sql);
                jasperDesign.setQuery(newQuery);
                JasperReport jasperReport=JasperCompileManager.compileReport(jasperDesign);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLaporanPengeluaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
