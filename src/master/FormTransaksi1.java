 ...
 */
public class FormTransaksi1 extends javax.swing.JFrame {
...
//        JOptionPane.showMessageDialog(null, "Hanya Diperbolehkan Numerik");
    ...
    public static Date getTanggalFromTable(JTable table, int kolom) {
        ...
        try {
            ...
            Logger.getLogger(FormTransaksi1.class
    ...
    private void pindahdatapesan() {
        ...
        master.FormTransaksi1.txt_id_trans.setText(cr1);

        row = jTable1.getSelectedRow();
        String cr2 = (jTable1.getValueAt(row, 1).toString());
        master.FormTransaksi1.txt_idjenis.setText(cr2);
        ...
        master.FormTransaksi1.txtHargaLaundry.setText(cr4);

        row = jTable1.getSelectedRow();
        String cr5 = (jTable1.getValueAt(row, 4).toString());
        master.FormTransaksi1.txtJumlah.setText(cr5);

        row = jTable1.getSelectedRow();
        String cr6 = (jTable1.getValueAt(row, 5).toString());
        master.FormTransaksi1.txtTotalHarga.setText(cr6);
        master.FormTransaksi1.txt_total_update.setText(cr6);
    ...
    private void total_harga() {
        int a = Integer.parseInt(FormTransaksi1.txtHargaLaundry.getText());
        int b = Integer.parseInt(FormTransaksi1.txtJumlah.getText());
        int c = a * b;

        FormTransaksi1.txtTotalHarga.setText(Integer.toString((int) (c)));

    }

    private void total_pesanan() {
        int d = Integer.parseInt(FormTransaksi1.txtBiayalaundry.getText());
        int e = Integer.parseInt(FormTransaksi1.txtTotalHarga.getText());
        int f = d + e;
        int potmember = f * 10 * 100;
        int total = f - potmember;

        if (txtStatusMember.getText().equals("Member")) {
            FormTransaksi1.txtBiayalaundry.setText(Integer.toString((int) (total)));
        } else if (txtStatusMember.getText().equals(("Non Member"))) {
            FormTransaksi1.txtBiayalaundry.setText(Integer.toString((int) (f)));
        }
...
//        int j = Integer.parseInt(Transaksi.txt_biayalaundry.getText());
        int k = Integer.parseInt(FormTransaksi1.txtTotalHarga.getText());
        int l = Integer.parseInt(FormTransaksi1.txt_total_update.getText());
//        int m = (j-l)+k;
        int m = l + k;
        FormTransaksi1.txtBiayalaundry.setText(Integer.toString((int) (m)));

    }

    private void pajak_service() {
        int n = Integer.parseInt(FormTransaksi1.txtBiayalaundry.getText());
        int o = (n * 3) / 100;
    ...
    private void n_pajak_service() {
        ...
        int q = Integer.parseInt(FormTransaksi1.txtBiayalaundry.getText());
        int r = p + q;
  ...
  //--------------------------------------------------------------------------//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTransaksi1.class
